...
public class PokemonGymImpl implements PokemonGym {
    ...
    public void performAttackPlayer(Pokemon pokemon, Pokemon gymPokemon, String attack){
        ...
        switch (pokemon.getType()) {
            ...
            case "water" -> {
                water = new WaterPokemon(pokemon.getName(), pokemon.getLevel(), pokemon.getHp(), pokemon.getFood(), pokemon.getSounds());
                switch (choosenAttack) {
            ...
            case "grass" -> {
                grass = new GrassPokemon(pokemon.getName(), pokemon.getLevel(), pokemon.getHp(), pokemon.getFood(), pokemon.getSounds());
                switch (choosenAttack) {
            ...
            default -> {
                electric = new ElectricPokemon(pokemon.getName(), pokemon.getLevel(), pokemon.getHp(), pokemon.getFood(), pokemon.getSounds());
                switch (choosenAttack) {
    ...
    public void gymOwnerAttacks(Pokemon gymPokemon, Pokemon pokemon){
        ...
        switch (gymPokemon.getType()) {
            ...
            case "water" -> {
                water = new WaterPokemon(gymPokemon.getName(), gymPokemon.getLevel(), gymPokemon.getHp(), gymPokemon.getFood(), gymPokemon.getSounds());
            ...
            case "grass" -> {
                grass = new GrassPokemon(gymPokemon.getName(), gymPokemon.getLevel(), gymPokemon.getHp(), gymPokemon.getFood(), gymPokemon.getSounds());
            ...
            default -> {
                electric = new ElectricPokemon(gymPokemon.getName(), gymPokemon.getLevel(), gymPokemon.getHp(), gymPokemon.getFood(), gymPokemon.getSounds());
